...
export default function UnifiedSearchPage({ searchCbt, pdfLibrary, wrongNotes, bookmarks = [], notes = [], cards = [], onOpenCbt, onOpenPdf }) {
  ...
  return <main className="page-shell"><section className="page-title"><div><span className="eyebrow">MAKEROS KNOWLEDGE</span><h1>통합 검색</h1><p>CBT, PDF, 오답, 북마크, AI 노트와 단어카드를 한 번에 검색하세요.</p></div></section>
