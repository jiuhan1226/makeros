...
export default function NotesCardsPage({ assets, onDelete, onGenerateFromWrong, busy, initialFocus }){
 ...
 return <main className="page-shell"><section className="page-title"><div><span className="eyebrow">AI STUDY ASSETS</span><h1>AI 노트 · 단어카드</h1><p>CBT 과목과 PDF 파일별로 정리된 AI 노트와 단어카드를 확인하세요.</p></div><button className="primary" disabled={busy} onClick={onGenerateFromWrong}>{busy?"AI 생성 중…":"현재 CBT 오답으로 생성"}</button></section>
