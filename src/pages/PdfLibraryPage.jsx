...
export default function PdfLibraryPage({ library, onRefresh, onOpen, onCreateAssets }){
 ...
 return <main className="page-shell"><section className="page-title"><div><span className="eyebrow">PDF LIBRARY</span><h1>PDF 라이브러리</h1><p>업로드한 자료를 이어서 학습하고 AI 노트와 개념카드를 만들어 보세요.</p></div><button className="primary" onClick={()=>onOpen(null,1)}>새 PDF 업로드</button></section>
